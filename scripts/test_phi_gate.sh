#!/usr/bin/env bash
# scripts/test_phi_gate.sh — T23 integration test for /sync-sweep PHI input gate.
#
...
Talked to Dr. Rookwood about onboarding next week.
Patient intake form had SSN: 123-45-6789 mid-paragraph — flag for compliance.
Also need to follow up with AFC Urgent Care on the Nestmate panel.
EOF
...
Talked to Dr. Rookwood about onboarding next week.
Need to follow up with AFC Urgent Care on the Nestmate panel.
Cyrus pinged about MDland routing — push to Lincoln Lab.
EOF
