...
def map_meeting_notes(ds, master_tasks_ds_id=None):
    ...
    attendees = find_prop(props, ["people"], ["attendee", "particsalesnt", "with"])
    if not attendees:
