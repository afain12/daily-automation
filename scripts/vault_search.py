...
Usage:
  python scripts/vault_search.py "demo proposal person-a"
  python scripts/vault_search.py "example account 4/21" --top-n 3
  python scripts/vault_search.py "product back burner" --json
  python scripts/vault_search.py "person-a" --paths vault/notes,vault/meetings

Output (default text mode):
  1. [3.42] vault/daily/2026-05-13.md
     Example Contact closed for the lab — the product mapping was stale...
  2. [2.91] vault/notes/Person A-touchpoints.md
     Multi-dept contact: lab (Operations/Example Account) and sales (SASales cleanup)...
  ...
