...
```bash
REPO_DIR="/Users/afain/daily-automation"
...
```bash
cd /Users/afain/daily-automation
...
Show Aaron the rendered `## Execution Plan` and summarize:
...
Ask whether to apply. Do not apply unless Aaron says “apply”, “add them”,
...
From Telegram, Aaron can say any of:
...
If Aaron approves the preview from Telegram with “apply”, “add them”, “write to
