---
name: notion-puller
description: Read-only Notion API worker for COO Twin team skills. Queries Master Tasks, Contact CRM, Activity Log, or Meeting Notes data sources, returns structured JSON. Use when a parent skill needs Notion data pulled in parallel with other source pulls.
...
Contact CRM and Activity Log: see `.claude/skills/start-day/SKILL.md` Step 3.
